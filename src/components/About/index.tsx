    ...
    return (
        <Element name="about" className="element dark:bg-linear-gray">
            <section data-aos="fade-up" className="container-personalizado py-32 ">
                ...
                {t("p")} <strong>Josué Lobo</strong>, {t("p2")} <strong>{t("p3")}</strong>, {t("p4")} <strong>{t("p5")}</strong> {t("p6")} <strong>{t("p7")} </strong>{t("p8")} <br /><br /> {t("p9")} <a className="hover:underline text-blue-light-200 dark:text-blue-dark-100" href="mailto:jojosuelobo@gmail.com">jojosuelobo@gmail.com</a> 
                </p>
